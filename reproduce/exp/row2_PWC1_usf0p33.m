% Table 1, Row 2
% data: PWC1, USF: 0.33
load dataset_PWC1.mat;
load samples_dataset_PWC1_usf0p33.mat;
name = 'row2_PWC1_usf0p33';
%%
%global settings
...
param_ap.svd_type = 'rsvd'; %'econ'  = MATLAB svd with 'econ' option (best for large r)
