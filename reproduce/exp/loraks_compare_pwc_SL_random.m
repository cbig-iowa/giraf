...
load samples_loraks_data_random.mat;
name = 'loraks_compare_pwc_SL_random';
%%
%global settings
settings.R = 4;
...
param_loraks.mask = 'kMask_random.mat';

param_loraks.r = 30;

exp_loraks_r30.name = 'LORAKS, r=30';
...
exp_loraks_r35.name = 'LORAKS, r=35';
...
exp_loraks_r40.name = 'LORAKS, r=40';
...
exp_loraks_r45.name = 'LORAKS, r=45';
exp_loraks_r45.opt_handle = @opt_loraks_wrapper;
exp_loraks_r45.settings = settings;
exp_loraks_r45.param = param_loraks;

%GIRAF settings
param_giraf.lambda = 1e-10;%1e-10;%1e-10; %regularization parameter
param_giraf.iter = 50; %number of iterations
param_giraf.eta = 1.3; %epsilon decrease factor;    end   
